...
export default function PrimarySearchAppBar() {
	...
	const { getSearchRealty } = useActions()
	const handleSearch = (e: ChangeEvent<HTMLInputElement>) => {
		if (!e.target.value) {
			getSearchRealty(null)
			setSearchValue(null)
			return
		}
		setSearchValue(e.target.value)
		getSearchRealty(searchValue)
	}
	...
	return (
		<Box sx={{ flexGrow: 1 }}>
			<AppBar position="static" sx={{ color: '#fff', backgroundColor: 'transparent', position: 'absolute' }}>
				<Toolbar>
					<IconButton
						size="large"
						edge="start"
					...
					<div className="search__header-block">
						<Search>
							<SearchIconWrapper>
								<SearchIcon />
							</SearchIconWrapper>
